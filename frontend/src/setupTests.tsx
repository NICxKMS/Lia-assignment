...
vi.mock("framer-motion", () => {
  ...
  const motionProps = new Set([
    ...
    'whileInView', 'variants', 'transition', 'layout', 'layoutId', 'drag', 'dragConstraints',
    'dragElastic', 'dragMomentum', 'dragTransition', 'onDragStart', 'onDrag', 'onDragEnd',
  ...
  const Mock = React.forwardRef<HTMLElement, Record<string, unknown>>((props, ref) =>
...
vi.mock("recharts", () => {
  const Mock = ({ children }: { children?: React.ReactNode }) => <div data-recharts-mock>{children}</div>;
  return {
