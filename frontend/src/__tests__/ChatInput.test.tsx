...
describe("ChatInput", () => {
	...
	describe("Form Submission", () => {
		it("calls onSubmit when form is submitted", async () => {
			...
			const form = screen
				.getByPlaceholderText("Send a message...")
				.closest("form");
	...
	describe("Stop Button", () => {
		it("shows stop button when streaming", () => {
			render(
				<ChatInput {...defaultProps} status="streaming" onStop={vi.fn()} />,
			);
		...
		it("shows stop button when submitted", () => {
			render(
				<ChatInput {...defaultProps} status="submitted" onStop={vi.fn()} />,
			);
		...
		it("calls onStop when stop button is clicked", async () => {
			...
			const onStop = vi.fn();
			render(
				<ChatInput {...defaultProps} status="streaming" onStop={onStop} />,
			);
	...
	describe("Status Handling", () => {
		...
		it("prefers status over isStreaming", () => {
			render(
				<ChatInput {...defaultProps} isStreaming={false} status="streaming" />,
			);
