...
describe("MessageList", () => {
	...
	describe("Empty State", () => {
		...
		it("renders suggestion buttons in empty state", () => {
			...
			expect(
				screen.getByText(/What are the advantages of using Next.js/i),
			).toBeInTheDocument();
			expect(
				screen.getByText(/Write code to demonstrate Dijkstra/i),
			).toBeInTheDocument();
			expect(
				screen.getByText(/Help me write an essay about Silicon Valley/i),
			).toBeInTheDocument();
			expect(
				screen.getByText(/What is the weather in San Francisco/i),
			).toBeInTheDocument();
		});
	});
	...
	describe("Thoughts Section", () => {
		...
		it("expands thoughts section when clicked", async () => {
			...
			expect(
				screen.queryByText("First thoughtSecond thought"),
			).not.toBeInTheDocument();
			...
			await waitFor(() => {
				expect(
					screen.getByText("First thoughtSecond thought"),
				).toBeInTheDocument();
			});
		});
