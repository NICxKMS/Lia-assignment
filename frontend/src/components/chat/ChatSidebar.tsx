...
import { Plus, Trash2, MessageSquare, ChevronRight, ChevronDown, LogOut, Loader2, PanelLeftClose, PanelLeft } from 'lucide-react'
      ...
      <div className="border-t border-border p-4 space-y-3">
        ...
        {user && (
          <div className="flex items-center justify-between">
            ...
            <Button onClick={onLogout} variant="ghost" size="icon" className="h-8 w-8">
              <LogOut className="w-4 h-4" />
            </Button>
          </div>
        )}
