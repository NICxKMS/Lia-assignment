        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-mono text-muted-foreground">{modelSettings.temperature.toFixed(2)}</span>
            </div>
            <Slider
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Input
                ...
                onChange={(e) => updateSetting('maxTokens', Math.min(32000, Math.max(1, parseInt(e.target.value) || 1)))}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-mono text-muted-foreground">{modelSettings.topP.toFixed(2)}</span>
            </div>
            <Slider
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-mono text-muted-foreground">{modelSettings.frequencyPenalty.toFixed(2)}</span>
            </div>
            <Slider
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-mono text-muted-foreground">{modelSettings.presencePenalty.toFixed(2)}</span>
            </div>
            <Slider
